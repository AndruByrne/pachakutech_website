                        ...
                        .map((block) => switch (block) {
                              ...
                              BlogEntry_ContentBlock(
                                ...
                                linkUrl: final linkUrl
                                  ...
                                  when block.hasTitle() &&
                                      ...
                                      block.hasLinkUrl() &&
                                      linkUrl.isNotEmpty =>
                                _wrapVideoLink(extractVideoId(linkUrl)) ??
                              ...
                              BlogEntry_ContentBlock(
                                ...
                                StaggeredGridTile.count(
                                    crossAxisCellCount: 2,
                                    mainAxisCellCount: 2,
                                    child: _hyperlinkedImage(imgUrl, linkUrl)),
                              // Case: image only
                              ...
                              BlogEntry_ContentBlock(title: final title)
                                  when block.hasTitle() && title.isNotEmpty =>
      ...
      StaggeredGridTile.count(
        ...
        child: Column(
          children: [
            ...
            Image.network(linkUrl)
          ],
        ),
      );
}

_wrapVideoLink(extractVideoId) => extractVideoId == null
    ? null
    : StaggeredGridTile.count(
        crossAxisCellCount: 2,
        mainAxisCellCount: 2,
